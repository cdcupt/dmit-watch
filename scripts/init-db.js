#!/usr/bin/env node
// Smoke / bootstrap: open (create) the SQLite store, seed the 33 Premium plans
...
function main() {
  ...
  if (plans.length !== 33) {
    console.error(`\nFAIL: expected 33 plans, got ${plans.length}`);
    process.exit(1);
  }
  console.log('\nOK: store created + 33 plans seeded + read back.');
}
